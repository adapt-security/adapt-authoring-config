...
import { envVarToConfigKey } from './utils/envVarToConfigKey.js'
...
class ConfigModule extends AbstractModule {
   ...
   * @deprecated Use envVarToConfigKey() from 'adapt-authoring-config' instead
   */
  envVarToConfigKey (envVar) {
    return envVarToConfigKey(envVar)
  }
